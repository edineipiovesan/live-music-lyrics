...
def test_multiple_clients_connect_simultaneously(test_client):
    ...
    with test_client.websocket_connect("/ws") as ws1, test_client.websocket_connect("/ws") as ws2:
...
def test_websocket_applies_pending_recognition(test_client, wiremock_base_url, patch_api_urls, clean_wiremock):
...
def test_websocket_same_song_does_not_refetch(test_client, wiremock_base_url, patch_api_urls, clean_wiremock):
...
def test_websocket_history_updated_on_song_change(test_client, wiremock_base_url, patch_api_urls, clean_wiremock):
    _stub_lrclib(wiremock_base_url)
    _stub_itunes(wiremock_base_url)
    _stub_wiki(wiremock_base_url)
...
def test_websocket_history_capped_at_max(test_client, wiremock_base_url, patch_api_urls, clean_wiremock):
